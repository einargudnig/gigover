...
export const NewAddProjectModal: FC<ProjectModalProps> = ({
	project,
	open: drawerOpen,
	onClose,
	title
	...
	return (
		<>
			<Drawer isOpen={isOpen} placement="right" onClose={drawerClose} size="lg">
				<DrawerOverlay />
								...
								<TabPanels>
									...
									<TabPanel>
										...
										<Box marginTop={2}>
											...
											{selectedProperty && (
												<Flex marginTop={2} justifyContent={'justify-end'}>
													<Button
														onClick={() => addProject()}
														isLoading={isLoading}
														variant={'outline'}
